...
func wireApp(confServer *conf.Server, elasticsearch *conf.Elasticsearch, registry *conf.Registry, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
