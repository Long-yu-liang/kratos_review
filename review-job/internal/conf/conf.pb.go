...
type Kafka struct {
	...
	GropuId       string                 `protobuf:"bytes,2,opt,name=gropu_id,json=gropuId,proto3" json:"gropu_id,omitempty"`
...
func (x *Kafka) GetGropuId() string {
	if x != nil {
		return x.GropuId
	}
	return ""
...
const file_conf_conf_proto_rawDesc = "" +
	...
	"\bgropu_id\x18\x02 \x01(\tR\agropuId\x12\x14\n" +
